        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto p-4 md:p-8">
            <div class="container mx-auto max-w-2xl">
                ...
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-8">
                    <div>
                        <h2 class="text-2xl font-extrabold text-gray-900 tracking-tight">Edit Harga Pulsa</h2>
                        <p class="text-sm text-gray-500 mt-1">Mengubah konfigurasi nominal atau skema harga untuk Pulsa Rp{{ number_format($hargaPulsa->jumlah_pulsa, 0, ',', '.') }}.</p>
                    </div>
                ...
                <div class="bg-white border border-gray-100 shadow-xl rounded-2xl p-6 md:p-8">
                    <form action="{{ route('admin.harga-pulsa.update', $hargaPulsa->id) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        {{-- Baris Struktur Harga (Grid 3 Kolom untuk Fleksibilitas / Menyesuaikan Skema Lama) --}}
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="harga_modal" id="harga_modal" 
                                        value="{{ old('harga_modal', $hargaPulsa->harga_modal ?? 0) }}"
