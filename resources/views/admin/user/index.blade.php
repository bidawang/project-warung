    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-6 md:p-10">
            <div class="container mx-auto">
                ...
                {{-- Tabel Daftar User (dibuat responsif dengan overflow) --}}
                        ...
                        <tbody>
                            @forelse ($users as $user)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 text-sm">
                                        <p class="text-gray-900 whitespace-no-wrap">{{ $user->nomor_hp ?? '-' }}</p>
                                    </td>
                                    <td class="px-5 py-5 border-b border-gray-200 text-sm text-right">
                                        ...
                                        <form action="{{ url('admin/user/destroy', $user->id) }}" method="POST"
                                            class="inline-block ml-2" onsubmit="return confirm('Apakah Anda yakin ingin menghapus user ini?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
