        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-6 md:p-10">
            <div class="container mx-auto">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                    <h1 class="text-3xl font-bold text-gray-800 mb-4 md:mb-0">Daftar Sub Kategori</h1>
                    <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 w-full md:w-auto">
                        ...
                        <form action="{{ route('admin.subkategori.index') }}" method="GET" class="relative w-full sm:w-auto">
                ...
                {{-- Tabel Daftar Sub Kategori (dibuat responsif dengan overflow) --}}
                            ...
                            @forelse ($subkategoris as $subkategori)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 text-sm text-right">
                                        <a href="{{ route('admin.subkategori.edit', $subkategori->id) }}"
                                        ...
                                        <form action="{{ route('admin.subkategori.destroy', $subkategori->id) }}" method="POST" class="inline-block ml-2" onsubmit="return confirm('Apakah Anda yakin ingin menghapus sub kategori ini?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
