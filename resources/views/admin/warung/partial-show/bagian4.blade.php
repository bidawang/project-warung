<div class="grid grid-cols-1 xl:grid-cols-3 gap-4 mt-4">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col">
        ...
        <div class="grid grid-cols-3 gap-2 p-3 border-b border-gray-100 bg-gray-50/50">
            ...
            <div class="bg-red-50/50 rounded-xl p-2 border border-red-100">
                <p class="text-[9px] uppercase font-bold text-red-400">
                    Total
                </p>

                <h4 class="text-xs font-black text-red-600">
                    Rp {{ number_format($totalHutang ?? 0, 0, ',', '.') }}
                </h4>
            </div>

            <div class="bg-yellow-50/50 rounded-xl p-2 border border-yellow-100">
                <p class="text-[9px] uppercase font-bold text-yellow-500">
                    Sisa
                </p>

                <h4 class="text-xs font-black text-yellow-600">
                    Rp {{ number_format($totalSisa ?? 0, 0, ',', '.') }}
                </h4>
            </div>

            <div class="bg-green-50/50 rounded-xl p-2 border border-green-100">
                <p class="text-[9px] uppercase font-bold text-green-500">
                    Lunas
                </p>

                <h4 class="text-xs font-black text-green-600">
            ...
            @forelse ($hutangList as $item)
                ...
                <div class="px-4 py-2.5 hover:bg-gray-50 transition flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="h-8 w-8 rounded-lg flex items-center justify-center font-black text-[11px]
                            {{ $isLunas ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-600' }}">
                            {{ strtoupper(substr($item->user->name ?? 'U', 0, 1)) }}
                        </div>

                        <div>
                            <h4 class="font-bold text-gray-800 text-xs truncate max-w-[120px]">
                                {{ $item->user->name ?? '-' }}
                            </h4>
                    ...
                    <div class="text-right">
                        ...
                        <div class="text-[9px] text-gray-400">
                            Awal: {{ number_format($item->total_awal, 0, ',', '.') }}
                        </div>
    ...
    <div x-data="{ open: null }"
        ...
        <div class="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
            ...
            <div class="text-right">
                <p class="text-[8px] uppercase tracking-wider text-gray-400">
                    Total Hutang
                </p>
                ...
                <div class="transition">
                    ...
                    <div class="px-4 py-2.5 hover:bg-gray-50 cursor-pointer flex items-center justify-between"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h4 class="font-bold text-gray-800 text-xs">
                                    HTG-{{ str_pad($hutang->id, 4, '0', STR_PAD_LEFT) }}
                                </h4>
                        ...
                        <div class="text-right">
                            ...
                            <div class="text-xs font-black text-yellow-600">
                                Rp{{ number_format($hutang->total, 0, ',', '.') }}
                            </div>

                            <span class="inline-block px-1.5 py-0.5 rounded text-[8px] font-black uppercase
                                {{ $hutang->status == 'lunas'
                    ...
                    <div x-show="open === {{ $i }}"
                        x-transition
                        x-cloak
                        class="bg-gray-50/80 px-4 py-3 border-y border-gray-100">
                            ...
                            @foreach ($hutang->hutangBarangMasuk as $detail)
                                ...
                                <div class="flex items-center justify-between text-[11px] bg-white p-2 rounded-lg border border-gray-100 shadow-sm">
                                    ...
                                    <div class="max-w-[150px]">
                                        ...
                                        <div class="text-[9px] text-gray-400">
                                            Exp:
                                            {{ $detail->barangMasuk->tanggal_kadaluarsa ?? '-' }}
                                        </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col">
        ...
        <div class="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
            ...
            <div class="text-right">
                ...
                <p class="text-sm font-black text-red-600">
                    Rp{{ number_format($totalHutangPulsaMasuk ?? 0, 0, ',', '.') }}
                </p>
        ...
        {{-- LIST --}}
        <div class="divide-y divide-gray-50 max-h-[475px] overflow-y-auto">

            @forelse($hutangPulsaMasuk as $trx)
                ...
                <div class="px-4 py-3 hover:bg-gray-50 transition">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="h-9 w-9 rounded-xl bg-red-100 text-red-700 flex items-center justify-center text-[10px] font-black">
                                PLS
                            </div>
                            ...
                            <div>
                                ...
                                <h4 class="font-bold text-gray-800 text-xs">
                                    {{ $trx->pulsa->jenisPulsa->nama_jenis ?? '-' }}
                                </h4>
                    ...
                    <div class="mt-2 flex items-center justify-between text-[10px]">
                        ...
                        <div class="text-gray-500">
                            ...
                            <span class="font-bold text-gray-700">
                                Rp{{ number_format($trx->harga_alomogada, 0, ',', '.') }}
                            </span>

                        </div>

                        <span class="px-2 py-1 rounded-md bg-red-100 text-red-700 font-bold uppercase text-[9px]">
                            Hutang
                        </span>
