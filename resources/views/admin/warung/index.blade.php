    ...
    <div class="container mx-auto" x-data="{ showAlert: true }">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            ...
            <a href="{{ route('admin.warung.create') }}"
                ...
                <svg class="w-5 h-5 mr-2 transform group-hover:rotate-90 transition-transform" fill="none"
                    ...
                    <thead>
                        <tr class="bg-gray-50">
                            ...
                            <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Pemilik
                                & Area</th>
                            <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Modal
                            </th>
                            <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">
                                Keterangan</th>
                        ...
                        @forelse ($warungs as $warung)
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <div class="text-xs text-gray-400 font-medium uppercase">ID:
                                        WRG-{{ str_pad($warung->id, 4, '0', STR_PAD_LEFT) }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex flex-col">
                                        ...
                                        <span class="text-xs text-blue-600 font-medium flex items-center mt-1">
                                            <svg class="w-3.5 h-3.5 mr-1.5 text-blue-400" fill="currentColor"
                                                viewBox="0 0 20 20">
                                                <path fill-rule="evenodd"
                                    ...
                                    <div class="flex justify-end gap-1">
                                        ...
                                        <a href="{{ route('admin.warung.setting', $warung->id) }}"
                                            ...
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 11-2.83 2.83l-.06-.06A1.65 1.65 0 0015 19.4a1.65 1.65 0 00-1 .6 1.65 1.65 0 01-2 0 1.65 1.65 0 00-1-.6 1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 11-2.83-2.83l.06-.06A1.65 1.65 0 004.6 15a1.65 1.65 0 00-.6-1 1.65 1.65 0 010-2 1.65 1.65 0 00.6-1 1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 112.83-2.83l.06.06A1.65 1.65 0 009 4.6a1.65 1.65 0 001-.6 1.65 1.65 0 012 0 1.65 1.65 0 001 .6 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 112.83 2.83l-.06.06A1.65 1.65 0 0019.4 9c.24.33.38.73.38 1.15s-.14.82-.38 1.15a1.65 1.65 0 000 1.7z" />
                                        ...
                                        {{-- Delete --}}
                                        <form action="{{ route('admin.warung.destroy', $warung->id) }}" method="POST"
                                            class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button"
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-16 text-center text-gray-400">
                                    <div class="flex flex-col items-center">
                                        <svg class="w-16 h-16 text-gray-100 mb-4" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
