            ...
            <tbody class="divide-y divide-gray-100 text-sm">
                ...
                @forelse($groupedRiwayat as $groupName => $items)
                    ...
                    @php
                        ...
                        // 🔥 FIX UTAMA: langsung pakai total dari database
                        $totalGrup = $items->sum('total');
                    @endphp
                    ...
                    <tr x-data="{ open: false }" class="border-b last:border-none">
                        <td colspan="4" class="p-0">
                            ...
                            {{-- HEADER --}}
                            <div @click="open = !open"
                                class="flex items-center px-6 py-4 cursor-pointer hover:bg-gray-50 transition group">

                                <div class="w-10">
                                    <svg :class="open ? 'rotate-180 text-blue-600' : 'text-gray-400'"
                                ...
                                <div class="flex-1 flex justify-between items-center">
                                    ...
                                    <div>
                                        <span class="font-bold text-gray-800 group-hover:text-blue-600">
                                            {{ $firstItem->stokWarung->warung->nama_warung ?? 'N/A' }}
                                        </span>

                                        <span class="ml-2 text-gray-500 text-xs">
                                            {{ $firstItem->created_at?->format('d M Y') }}
                                        </span>
                                    </div>
                            ...
                            <div x-show="open" x-collapse
                                class="bg-gray-50/50 px-16 pb-4 pt-2 border-t border-gray-100">
