                            ...
                            @forelse ($barangs as $barang)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-5 py-5 border-b border-gray-200 text-sm">
                                        <p class="text-gray-900 whitespace-no-wrap">{{ $barang->subKategori->kategori->nama_kategori }}</p>
                                    </td>
                                    <td class="px-5 py-5 border-b border-gray-200 text-sm">
                                        <p class="text-gray-900 whitespace-no-wrap">{{ $barang->subKategori->nama_sub_kategori }}</p>
                                    </td>
                                    <td class="px-5 py-5 border-b border-gray-200 text-sm">
