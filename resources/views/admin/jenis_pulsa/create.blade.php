...
@section('title', 'Tambah Jenis Pulsa')
...
<div class="flex-1 flex flex-col overflow-hidden">
    <main class="flex-1 overflow-y-auto bg-gray-100 p-6 md:p-10">
        <div class="container mx-auto max-w-xl">
            ...
            <h2 class="text-3xl font-bold text-gray-800 mb-6">Tambah Jenis Pulsa</h2>
            ...
            <div class="bg-white shadow rounded-lg p-6">
                <form action="{{ route('admin.jenis-pulsa.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="nama_jenis"
                               ...
                               placeholder="Contoh: Pulsa Reguler" required>
                    </div>
