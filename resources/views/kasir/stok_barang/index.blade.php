...
@section('title', 'Data Stok Warung & Barang Keluar')
...
<div class="row">
    ...
    <div class="col-md-4">
        {{-- Kita pindahkan logika tampilan barang keluar ke partial view --}}
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="list-unstyled mb-2">
                                        ...
                                        {{-- Menggunakan $item->kuantitas_list yang sudah di-sort di controller --}}
                                        @forelse($item->kuantitas_list as $kuantitas)
                                        <li class="d-flex justify-content-between align-items-center mb-1 p-2 border rounded-3 bg-light">
                                            <span>
