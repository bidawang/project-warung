                            ...
                            <tbody>
                                @foreach ($harga_pulsas as $harga)
                                    <tr class="harga-item" data-nominal="{{ $harga->jumlah_pulsa }}" data-operator="{{ strtolower($harga->operator ?? '-') }}">
                                        ...
                                        <td class="text-center pe-4"><span class="badge bg-soft-info text-primary rounded-pill">{{ ucfirst($harga->nama_jenis) }}</span></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
