                    ...
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item ms-2">
                            <a class="nav-link px-4 rounded-pill {{ $status == 'dikirim' ? 'active bg-warning text-dark shadow-sm' : 'text-muted' }}"
                                href="?status=dikirim">
                                <i class="fas fa-truck me-2"></i>Menunggu Konfirmasi
                            </a>
                        </li>
                        <li class="nav-item ms-2">
                            ...
                            <tbody>
                                @forelse($data as $r)
                                    <tr class="hover-row">
                                        ...
                                        <td>
                                            <div class="fw-bold text-dark">{{ $r->barang->nama_barang ?? 'Barang Hilang' }}
                                            </div>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex align-items-center justify-content-center gap-2">
                                                {{-- Angka Utama --}}
                                                <span class="badge bg-soft-info text-info rounded-pill px-3 py-2 fs-6">
                                                    {{ number_format($r->jumlah_dibeli ?? 0, 0, ',', '.') }}
                                                </span>

                                                {{-- Label Belanja Tambahan (Samping Angka, 1 Kata 1 Baris) --}}
                                                @if ($r->keterangan != null)
                                                    <div class="text-start lh-1" style="max-width: 60px;">
                                                        <small class="text-primary fw-bold text-uppercase p-0"
                                        ...
                                        <td class="text-center pe-4">
                                            ...
                                            @endphp
                                            <span class="badge {{ $colorClass }} rounded-pill px-3 py-2 fw-normal"
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-center py-5">
                                            <div class="text-muted">
                                                ...
                                                <p class="mb-0">Tidak ada rencana belanja dengan status
