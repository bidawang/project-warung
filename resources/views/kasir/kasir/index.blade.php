            ...
            <div class="card shadow-lg border-0 h-100">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="input-group mb-3 sticky-top p-0 bg-white" style="top: -16px; z-index: 10;">
                        ...
                        <input type="text" id="searchInput" class="form-control form-control-lg" placeholder="Cari produk berdasarkan nama...">
                    </div>
                    ...
                    <div class="row g-3 product-grid" id="productList">
                        @forelse($products as $product)
                            <div class="col-6 col-sm-4 col-md-3 col-xl-2 d-flex product-item"
                                ...
                                <button type="button" class="card product-card text-decoration-none shadow-sm h-100 w-100 border-0 rounded-3 text-start add-to-cart-btn"
                                    data-id="{{ $product->id }}"
                                    ...
                                    <div class="card-body p-2 d-flex flex-column justify-content-between">
                                        <div class="d-flex align-items-center mb-1">
                                            ...
                                            <h6 class="card-title my-0 flex-grow-1 text-truncate" style="font-size: 0.9em;">
                                        ...
                                        <div class="text-end">
                                            ...
                                            <small class="text-muted" style="font-size: 0.8em;">Stok: <span class="product-stock-count">{{ $product->stok_saat_ini }}</span></small>
                                        </div>
                                    </div>
                                </button>
                            </div>
                        @empty
                            <div class="col-12">
                                <p class="text-center text-muted py-5"><i class="fas fa-times-circle me-2"></i>Tidak ada produk tersedia di warung ini.</p>
                            </div>
                        @endforelse
                    </div>
                </div>
        ...
        <div class="col-lg-4 col-xl-5">
            <div class="card shadow-lg border-0 h-100">
                ...
                <div class="card-body d-flex flex-column">
                    <form id="checkoutForm" action="{{ route('kasir.barangkeluar.store') }}" method="POST" class="flex-grow-1 d-flex flex-column">
                        @csrf
                        ...
                        <div class="cart-scroll-area flex-grow-1 mb-3" style="max-height: 400px; overflow-y: auto;">
                            <ul class="list-group" id="cartList">
                                <li class="list-group-item text-center text-muted" id="emptyCartMessage">Keranjang kosong. Tambahkan produk!</li>
                            </ul>
                        </div>
                        ...
                        <div id="paymentSection">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control form-control-lg text-end" id="payment" name="bayar" placeholder="0" min="0" value="0">
                            </div>
                            <div class="form-group mb-3">
                                <label for="change" class="form-label fw-bold">Kembalian:</label>
                                <input type="text" class="form-control form-control-lg text-end fw-bolder text-primary" id="change" value="Rp 0" readonly>
                            </div>
                        </div>
...
#cartList .list-group-item {
    border-left: 4px solid #17a2b8; /* Border kiri warna info */
    border-radius: .25rem;
    margin-bottom: 5px;
