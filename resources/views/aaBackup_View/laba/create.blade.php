...
@section('title', 'Tambah Data Laba')
...
<div class="container">
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <h1 class="text-center my-4">Tambah Data Laba Baru</h1>
            <div class="card p-4">
                ...
                <form action="{{ route('laba.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control" id="input_minimal" name="input_minimal" value="{{ old('input_minimal') }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="input_maksimal" class="form-label">Input Maksimal</label>
                        <input type="number" step="0.01" class="form-control" id="input_maksimal" name="input_maksimal" value="{{ old('input_maksimal') }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="harga_jual" class="form-label">Harga Jual</label>
                        <input type="number" step="0.01" class="form-control" id="harga_jual" name="harga_jual" value="{{ old('harga_jual') }}" required>
                    </div>
                    <div class="mb-3">
