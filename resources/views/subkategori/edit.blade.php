...
<div class="container">
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <h1 class="text-center my-4">Edit Subkategori</h1>
            <div class="card p-4">
                ...
                <form action="{{ route('subkategori.update', $subkategori->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="subkategori" name="sub_kategori" value="{{ old('sub_kategori', $subkategori->sub_kategori) }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="keterangan" class="form-label">Keterangan (Opsional)</label>
                        <textarea class="form-control" id="keterangan" name="keterangan" rows="3">{{ old('keterangan', $subkategori->keterangan) }}</textarea>
                    </div>
